...
namespace Starfall.Food.Editor
{
    public static class FoodBuild
    {
        ...
        public static void Run()
        {
            ...
            PlayerSettings.companyName="StarfallComponentStudies";PlayerSettings.productName="Starfall Food - First Berry";PlayerSettings.bundleVersion="0.1.1-food.2";
            ...
            string folder="Builds/Food-0.1.1-"+DateTime.UtcNow.ToString("yyyyMMdd-HHmmss");Directory.CreateDirectory(folder);
