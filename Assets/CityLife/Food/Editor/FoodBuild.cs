...
namespace Starfall.Food.Editor
{
    public static class FoodBuild
    {
        ...
        public static void Run()
        {
            ...
            PlayerSettings.companyName="StarfallComponentStudies";PlayerSettings.productName="Starfall Food - First Berry";PlayerSettings.bundleVersion="0.1.3-food.4";
            ...
            string folder="Builds/Food-0.1.3-"+DateTime.UtcNow.ToString("yyyyMMdd-HHmmss");Directory.CreateDirectory(folder);
