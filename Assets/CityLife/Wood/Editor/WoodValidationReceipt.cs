...
namespace CityLife.Items.Editor {
 public static class WoodValidationReceipt {
  ...
  public static void Run() {
   ...
   try { receipt.checks=CityLife.Wood.FallenWoodChecks.Run().ToArray(); receipt.status="PASS"; code=0; }
   ...
   Debug.Log("WOOD_SUITE "+receipt.status+" named checks="+(receipt.checks==null?0:receipt.checks.Length));
