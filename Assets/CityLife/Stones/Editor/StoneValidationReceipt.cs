...
namespace CityLife.Items.Editor {
 public static class StoneValidationReceipt {
  ...
  public static void Run() {
   ...
   try { receipt.checks=CityLife.Stones.Editor.StoneValidation.Run().ToArray(); receipt.status="PASS"; code=0; }
   ...
   Debug.Log("STONE_SUITE "+receipt.status+" named checks="+(receipt.checks==null?0:receipt.checks.Length));
