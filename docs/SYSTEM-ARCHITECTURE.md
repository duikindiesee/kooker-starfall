...
| Food v0.1.5 Editor runtime | [Native visual/input gate passed](FOOD-EDITOR-ACCEPTANCE.md), same runtime source; trusted installed Unity Editor, SAC configuration unchanged | Standalone signing/launch, human acceptance and combined integration |
