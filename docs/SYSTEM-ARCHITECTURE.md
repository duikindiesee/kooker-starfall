...
|---|---|---|---|---|
| Hunter clothing and passive club | Isolated coverage/motion passed | Separate 20260913-180511 courtyard preview from 8659a92; no network, combat or weather wiring | [Component and evidence](HUNTER-CLOTHING.md), [hashed release](../evidence/verified/hunter-clothing-release.json) | Integrated camera/terrain/action revalidation, manual shortcut acceptance and sustained profiling |
